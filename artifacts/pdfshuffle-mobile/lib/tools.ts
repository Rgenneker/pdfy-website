...
export const TOOLS: Tool[] = [
  ...
  },
  {
    slug: "ppt-to-pdf",
    name: "PPT to PDF",
    description: "Convert PowerPoint presentations to PDF. Requires LibreOffice.",
  ...
  },
  {
    slug: "excel-to-pdf",
    name: "Excel to PDF",
    description: "Export Excel spreadsheets as formatted PDFs. Requires LibreOffice.",
    category: "coming-soon",
    icon: "stats-chart",
    inputType: "file",
  ...
  },
  {
    ...
    description: "Convert LibreOffice documents to PDF. Requires LibreOffice.",
    category: "coming-soon",
    icon: "layers",
    inputType: "file",
  ...
  },
  {
    slug: "compress-pdf",
    name: "Compress PDF",
    description: "Reduce PDF file size without losing quality. Requires Ghostscript.",
    category: "coming-soon",
    icon: "archive",
    inputType: "file",
    fileExtensions: [".pdf"],
  ...
  },
  {
    ...
    description: "Convert a PDF to a LibreOffice document. Requires LibreOffice.",
    category: "coming-soon",
